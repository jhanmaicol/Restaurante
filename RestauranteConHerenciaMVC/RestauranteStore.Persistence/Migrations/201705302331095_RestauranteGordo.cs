namespace RestauranteStore.Persistence.Migrations
{
    ...
    public partial class RestauranteGordo : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Almacenes", t => t.AlmacenId, cascadeDelete: true)
        ...
        {
            DropForeignKey("dbo.Provedores", "AlmacenId", "dbo.Almacenes");
            ...
            DropForeignKey("dbo.Ingredientes", "AlmacenId", "dbo.Almacenes");
